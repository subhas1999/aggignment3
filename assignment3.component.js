...
exports.Assignment3Component = void 0;
var core_1 = require("@angular/core");
var Assignment3Component = /** @class */ (function () {
    function Assignment3Component(service) {
    ...
    Assignment3Component.prototype.fetchData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.getData().then(function (res) {
                            _this.assign = res;
                            console.log(_this.assign);
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
